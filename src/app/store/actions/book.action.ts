...
import { createAction,props,on,createReducer,createFeatureSelector } from "@ngrx/store";
...
const bookFeatureSelector = createFeatureSelector(<string>(Book_FEATURE_NAME))
